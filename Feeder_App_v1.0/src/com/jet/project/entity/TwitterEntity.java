...
public class TwitterEntity {
	...
	@Transient
	public TwitterEntity consumeJSON(JSONObject entity){
//		GoogleActivitiesEntity gActEntity = new GoogleActivitiesEntity();
	...
	@Transient
	public JSONObject convertToJSON(TwitterEntity entity){
...
//		GoogleActivitiesEntity gActEntity = new GoogleActivitiesEntity();
	...
	@SuppressWarnings("unchecked")
	@Transient
	public JSONArray convertListToJSONArray(List<TwitterEntity> entities){
		JSONArray jsonArray = new JSONArray();
		
		LogUtil.log("Converting Java Arraylist to JSON Array..");

		for(TwitterEntity g : entities){
